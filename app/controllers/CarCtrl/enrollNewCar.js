...
module.exports = $baseCtrl(async (req, res) => {
  ...
  if (req.body.transportType === "travel") {
    ...
    existStation = await models.station.findOne({
      $or: [
        { $and: [{ gov1: gove1 }, { gov2: gove2 }] },
        { $and: [{ gov1: gove2 }, { gov2: gove1 }] },
      ],
    });
    if (!existStation)
      return APIResponse.BadRequest(res, " station not found .");
    req.body.station = existStation.id;
  }
