...
module.exports = $baseCtrl(async (req, res) => {
  ...
  if (!car) return APIResponse.NotFound(res, "No Car TO ENd journey on it");
  if (!car.current_journey)
    return APIResponse.Forbidden(res, "NO Journey started for this car");
  if (car.current_driver !== req.me.id)
    return APIResponse.Forbidden(res, "Dont allow to end this journey");
